...
def main():
    ...
    logfile = os.path.join(args.out_dir, 'fgsm_output.log')
    ...
    logging.basicConfig(
        ...
        datefmt='%Y/%m/%d %H:%M:%S',
        level=logging.INFO,
        filename=os.path.join(args.out_dir, 'fgsm_output.log'))
    logger.info(args)
    ...
    torch.save(best_state_dict, os.path.join(args.out_dir, 'fgsm_model.pth'))

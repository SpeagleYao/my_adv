...
from loss import LabelSmoothing, trades_loss
...
def get_args():
    ...
    parser.add_argument('--out-dir', default='trades_normal_output', type=str, help='Output directory')
...
#TODO:
    ...
    if args.lr_schedule == 'cyclic':
        ...
        scheduler = torch.optim.lr_scheduler.MultiStepLR(opt, milestones=[lr_steps-len(train_loader)], gamma=0.1)
